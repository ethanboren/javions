...
public class PowerComputerTest {
    ...
    @Test
    void CheckPowerComputerCalculatesWell() throws IOException {//NE MARCHAIS POOOOOOOOOOOOOOOOOOOOO
        FileInputStream stream = new FileInputStream("resources/samples.bin");
        PowerComputer computer = new PowerComputer(stream, 8);//C EST NRML QU IL L ACCEPTE PAS CAR C PO UN MULTIPLE DE 8
        int[] batch = new int[8];
    ...
    @Test
    void readbatchReturnsTheNumberOfEchantillonsRead() throws IOException {//EST CE QUE LES PUISSANCE NON CALCULE DOIVENT RESTER A ZERO ??? DEMANDER ASSISTANT
        FileInputStream stream = new FileInputStream("resources/samples.bin");
        PowerComputer powerComputer =  new PowerComputer(stream, 1208);
    ...
    void testValidPowerComputer() throws IOException {
        ...
        PowerComputer test2 = new PowerComputer(stream , 1208);

        short [] batch = new short[2402];
        int [] batch2 = new int[1208];
