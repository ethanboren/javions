...
public class Crc24Test {
    ...
    @Test
    void testBitWiseEnd2() {
        Crc24 crc24 = new Crc24(Crc24.GENERATOR);
        String mS = "8D4D2286EA428867291C08";
        String cS = "EE2EC6";
        int c = Integer.parseInt(cS, 16); // == 0x035DB8

        byte[] mAndC01 = HexFormat.of().parseHex(mS + cS);
        assertEquals(0, crc24.crc(mAndC01));
    ...
    void testBitWiseEnd7() {
        ...
        byte[] mOnly = HexFormat.of().parseHex(mS);
        assertEquals(c, crc24.crc(new byte[0]));
